					...
					<td>
						<div data-field="page" class="media table-fbpage">
							<div class="media-left media-middle">
								<span class="table-fbpage-img" style="background-image:url(http://graph.facebook.com/{{$account->social_account_name->real_id}}/picture) !important;background-size: 60px 60px !important;background-repeat: no-repeat !important;"></span>
							</div>
