		...
		<div class="top-left-part">
			...
			<a style="margin-left: 5px" class="logo" href="/home">
				...
				<span class="hidden-xs">
					<!--This is dark logo text--><img src="/admin/plugins/images/eliteadmin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="/admin/plugins/images/eliteadmin-text-dark.png" alt="home" class="light-logo" />
				</span>
			</a>
		</div>
		<!-- /Logo -->
